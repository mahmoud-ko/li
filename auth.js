/* AURUM — auth.js (آمن للتجربة على GitHub Pages) */
const API_BASE = '/backend/api'; // أو رابط خادم PHP الخارجي
...
/* ── Guest Login (آمن، بدون fallback عشوائي) ── */
...
if (loginBtn) {
    loginBtn.addEventListener('click', async () => {
        ...
        // محاولة الاتصال بالـ API الحقيقي (إذا كان الخادم يعمل)
        try {
        ...
        // وضع العرض التجريبي (ديمو) بقبول حساب واحد فقط مسبق التعريف
...
/* ── Guest Register ── (مثال، لن يسمح بإنشاء حساب جديد في وضع الديمو) */
...
/* ── Owner Login ── مماثل، مع حساب ديمو للمالك */
...
/* ── Social Login ── معطل في وضع الديمو */
